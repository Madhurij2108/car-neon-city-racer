...
Before changing this product, load the generated source graph:

- Machine graph: .aurelia/context/source-graph.json
- Human map: .aurelia/context/source-map.md
- Current state: .aurelia/context/current-state.json
