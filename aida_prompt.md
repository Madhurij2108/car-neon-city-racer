...
- Context pack: `.aurelia/context/tickets/car-8/context-pack.json`
- Human map: `.aurelia/context/tickets/car-8/context-pack.md`
...
2. Read compact map `.aurelia/context/tickets/car-8/context-pack.md` before opening source files.
3. Open `.aurelia/context/tickets/car-8/context-pack.json` only if the compact map is insufficient.
