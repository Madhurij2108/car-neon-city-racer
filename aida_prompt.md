...
Artifact: /home/ubuntu/2026/product-aidlc/projects/car-neon-city-racer/.aurelia/runs/tunnel_96d852e9-623a-4b9e-bfb6-5fd7edb1ed07-fb3dadcc.md
Lint: skipped
Build: failed
Test: skipped
...
Graph gate: passed. Changed source files stayed within ticket context pack `.aurelia/context/tickets/car-4/context-pack.json`.
...
Episode captured: 8a1b1f79-7712-477b-8fc3-e6ba197a698f
```
...
- Context pack: `.aurelia/context/tickets/car-4/context-pack.json`
- Human map: `.aurelia/context/tickets/car-4/context-pack.md`
...
2. Read compact map `.aurelia/context/tickets/car-4/context-pack.md` before opening source files.
3. Open `.aurelia/context/tickets/car-4/context-pack.json` only if the compact map is insufficient.
